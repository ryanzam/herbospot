...
const ProductCard = ({ product, viewMode }: ProductCardProps) => {
    ...
    const calculateDiscount = () => {
        // Random discount for demo (in real app, this would come from API)
        ...
        <Link href={`/products/${product.id}`}>
            ...
            >
                ...
                <div className="relative h-64 bg-gray-100 overflow-hidden">
                    ...
                    {discountInfo.hasDiscount && product.stock > 0 && (
                        <div className="absolute top-4 left-4 bg-gradient-to-r from-red-500 to-orange-500 text-white px-2 py-1 rounded-md text-sm font-bold z-10 shadow-lg">
                            -{discountInfo.discount}%
                        </div>
                    )}
